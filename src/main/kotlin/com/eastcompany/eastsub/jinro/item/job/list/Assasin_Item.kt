...
class Assasin_Item : SpecialItem() {
    override val tag = "assassin_0"
    override val lore = listOf("対象を\uE501で殺害")
    override val material = Material.STICK

    override val role = Role.ASSASSIN
    override val displayName = role.roleName + "スキル 切り裂き透明 \uE501で殺害 透明化10秒間"
    ...
    override fun onRightClick(
        ...
        val invisibilityEffect = PotionEffect(PotionEffectType.INVISIBILITY, 10 * 20, 0, true, false)
        player.addPotionEffect(invisibilityEffect)

        player.sendMessage("あなたは透明化した。")
    }
}